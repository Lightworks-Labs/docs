...
Installing a template opens a pull request in your repository. Uninstalled templates are archived, not deleted. Updates are tracked in `.lightworks/installed.json` and can be checked from the Installed tab.
